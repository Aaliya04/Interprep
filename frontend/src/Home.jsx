  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <button
        ...
        className="fixed top-20 left-6 z-50 bg-white shadow-md px-3 py-2 rounded-lg text-2xl"
      >
        ☰
      </button>
        ...
        <>
          ...
          <div className="fixed top-0 left-0 w-64 h-full bg-white shadow-lg z-50 p-6">
            ...
            <div className="flex flex-col gap-4 text-gray-700">
              ...
              <button onClick={() => navigate("/mockInterview")}>
                Mock Interview
              </button>
      ...
      <div className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-3 gap-8">
        ...
        {features.map((item, index) => (
          <motion.div
            ...
            whileHover={{ y: -6 }}
            onClick={() => {
              if (item.title.includes("Mock")) navigate("/mockInterview");
